...
module.exports = {
    ...
    execute({ inter }) {
        ...
        if (!queue) return inter.reply({ content: `Nenhuma música está tocando ${inter.member}... Tentar novamente? ❌`, ephemeral: true });
        ...
        .setFooter({ text: 'FRIDAY ONLINE', iconURL: inter.member.avatarURL({ dynamic: true })})
        .setColor('ff0000')
        .setTimestamp()
